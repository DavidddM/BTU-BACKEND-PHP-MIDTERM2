    ...
    <div
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                <form method="post" enctype="multipart/form-data" action="{{route('post_result')}}">
                        ...
                        <div class="p-6">
                            <div class="d-flex justify-content-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"
                                    ...
                                    <a class="underline text-gray-900 dark:text-white">{{$question->questionTitle}}</a>
                                </div>
                            </div>
                            <div class="ml-12">
                                ...
                                <div class="ml-12">
                                    <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                        @foreach($question -> answers as $answer)
                                            <div style="color: {{ $answer->isRight == 0 ? 'red' : 'green' }}">{{$answer->answerContent}}</div>
                                        @endforeach
                                    </div>
                                </div>
                            @endcan
